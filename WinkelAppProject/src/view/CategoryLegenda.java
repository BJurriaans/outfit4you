...
public class CategoryLegenda extends javax.swing.JPanel {
    QueryManager queryManager = WinkelApplication.getQueryManager();
    
    public CategoryLegenda() {
        initComponents(); 
        showLegenda();
        String naam = jComboBox1.getSelectedItem().toString();
        int id = queryManager.getCategoryId(naam);
     ...
     private void showLegenda(){
        ...
        jLabel2.setText(Integer.toString(c.getCategoryId()));
     }                
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Kies een categorie om het categorie_id te zien:");
