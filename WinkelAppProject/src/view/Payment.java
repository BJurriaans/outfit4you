...
public class Payment extends JPanel implements MouseListener, ActionListener {
    ...
    private final int productOffset = 20; //wordt keer i gedaan, zodat elk product goed onder elkaar komt te staan
    ...
    private void addTitle() { //als je op titel klikt ga je naar home
    ...
    private void addProductList() {
        List<Product> products = WinkelApplication.getBasket().getProducts(); //het zijn static methods, dus je hebt geen object nodig om deze methods aan te roepen. getproducts is niet static, dus moet je het via winkelapplication doen
    ...
    @Override
    public void actionPerformed(ActionEvent event) { //zet de gegevens in de DB en cleart de basket
