...
public class BasketDisplay extends JPanel implements ActionListener, Observer {
    ...
    public void actionPerformed(ActionEvent event) {
        WinkelApplication.getInstance().showPanel(new Payment()); //zorgt ervoor dat het Payment.java panel tevoorschijn komt. DEZE METHOD ZOU EEN GOED VOORBEELD KUNNEN ZIJN MET HOE WE ANDERE SCHERMPJES TEVOORSCHIJN KUNNEN HALEN
    }
}
